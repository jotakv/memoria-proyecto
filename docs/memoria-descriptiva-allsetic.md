...
| Oliva · Guillem de Castro | 50.000 € | 101 m² anunciados; 98 m² catastrales: 93 m² almacén + 5 m² comunes | Guillen de Castro 16, 1/AL/13 según Catastro | Ficha y consulta catastral; identidad/aptitud/financiación `[PENDIENTE]` | `locales/Oliva Ficha.pdf`; `locales/Oliva Catastro (2).pdf` | Entreplanta, un baño, año 2006; superficie y uso por reconciliar; precio superior a fuentes de la memoria final |

Las seis ofertas permiten establecer una **horquilla preliminar observada de 32.900 € a 50.000 €** y sitúan el presupuesto de referencia de 40.000 € dentro del mercado documentado. Este contraste acredita alternativas y razonabilidad inicial, no una tasación ni la idoneidad definitiva. Deberán verificarse `[PENDIENTE]` vigencia, comparabilidad territorial, disponibilidad, características, titularidad, cargas, uso, compatibilidad urbanística, estado y costes de cada activo que avance en el proceso. Los anuncios, fichas comerciales, notas simples, información catastral, informes técnicos o comparativas son soporte del estudio previo y no compromisos de compra.

La revisión de 01/09/2026 amplía el análisis en [el anexo II del dossier](https://github.com/jotakv/memoria-proyecto/blob/main/docupresentarsepe/04_ANEXO_II_ESTUDIO_MERCADO_INMOBILIARIO.md). Las simulaciones de las nuevas alternativas utilizan HYP-A25/HYP-A26 y las fuentes de 48.000 € de la memoria final; no equivalen a aprobación de financiación ni sustituyen los supuestos históricos del modelo general. El Ejido merece diligencia prioritaria entre las dos novedades; Oliva requiere resolver financiación, superficie, uso y acceso.
