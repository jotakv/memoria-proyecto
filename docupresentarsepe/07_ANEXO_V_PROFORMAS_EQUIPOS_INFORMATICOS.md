# 07 · Anexo V · Equipos informáticos
...
- [ ] Proforma nueva, vigente e identificable.
- [ ] Titular y datos fiscales correctos.
- [ ] Productos realmente necesarios para la actividad.
- [ ] IVA y total claramente desglosados.
- [ ] Sin pedido, pago o entrega anticipados incompatibles con la declaración.
- [ ] Fuente de financiación asignada sin duplicar el pago único previsto para el inmueble.

Este anexo no afirma admisibilidad y no convierte el documento existente en factura proforma válida.
