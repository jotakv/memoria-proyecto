# Expediente de preparación para pago único SEPE

Esta carpeta organiza una versión textual, trazable y ordenada del expediente de **Allsetic AI Automation Studio** para preparar una eventual solicitud de capitalización de la prestación por desempleo. No sustituye el formulario oficial, la resolución individual ni las fuentes canónicas del repositorio.

## Jerarquía documental

- **Fuente narrativa canónica:** [`docs/memoria-descriptiva-allsetic.md`](../docs/memoria-descriptiva-allsetic.md).
- **Control de adaptación SEPE:** [`memoria-sepe/MEMORIA_COMPLETA_SEPE.md`](../memoria-sepe/MEMORIA_COMPLETA_SEPE.md).
- **Plan empresarial:** [`plan-empresa/PLAN_EMPRESA_ALLSETIC.md`](../plan-empresa/PLAN_EMPRESA_ALLSETIC.md).
...
Los PDF inmobiliarios permanecen en [`locales/`](../locales/) y las proformas/presupuestos en [`proformas/`](../proformas/). No se copian, transforman ni duplican aquí. Los anexos Markdown actúan como índices y hojas de control; una ficha comercial o anuncio es evidencia de mercado, no factura proforma ni compromiso de compra.

## Estado de lectura

- Existen cinco fichas comerciales, dos notas simples y dos documentos catastrales (una certificación y una consulta) vinculadas al estudio previo.
