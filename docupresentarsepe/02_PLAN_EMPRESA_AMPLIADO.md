# 02 · Plan de empresa ampliado para el expediente SEPE

Este documento es una capa de presentación derivada del [plan de empresa completo](../plan-empresa/PLAN_EMPRESA_ALLSETIC.md). No lo sustituye ni modifica el modelo de negocio, mercado objetivo, servicios, previsiones o estrategia comercial.
...
La sede concentrará puesto técnico, equipos y periféricos, documentación y administración; permitirá reuniones, demostraciones, análisis, implantaciones y formación y separará vivienda y actividad. Su función es instrumental a la consultoría. No existe actividad inmobiliaria, uso residencial o estrategia de revalorización.

El orden empresarial de la decisión es:

1. necesidad operativa;
2. requisitos del espacio;
3. decisión de estudiar una adquisición estable;
4. búsqueda y comparación de mercado;
5. diligencia previa y selección;
6. inversión y financiación;
7. afectación y justificación documental.
